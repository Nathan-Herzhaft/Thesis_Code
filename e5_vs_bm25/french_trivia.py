...
# %%
raw_dataset = datasets.load_dataset("AIffl/french_trivia_qa_with_wikicontext", split="train",trust_remote_code=True)
...
passages = pd.Series(data_truncated['wiki_context']).apply(lambda x: 'passage: ' + x[0])
